(function (global, factory) {
    ...
    function add_css$1() {
    	var style = element("style");
    	style.id = "svelte-1k9t1tq-style";
    	style.textContent = ".container.svelte-1k9t1tq{width:100%;margin:0 auto;max-width:540px}";
    	append(document.head, style);
    }
    ...
    function create_fragment$4(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(img, "alt", "");
    			attr(img, "width", /*width*/ ctx[0]);
    			attr(div, "class", "container svelte-1k9t1tq");
    		},
    		m(target, anchor, remount) {
    			insert(target, div, anchor);
    			append(div, button0);
    			...
    			dispose = [
    				listen(button0, "click", function () {
    					if (is_function(/*methods*/ ctx[2].makeSmaller)) /*methods*/ ctx[2].makeSmaller.apply(this, arguments);
    				}),
    				listen(button1, "click", function () {
    					if (is_function(/*methods*/ ctx[2].makeLarger)) /*methods*/ ctx[2].makeLarger.apply(this, arguments);
    				})
    			];
    		},
    		p(new_ctx, [dirty]) {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$set = $$props => {
    		...
    		if ("methods" in $$props) $$invalidate(2, methods = $$props.methods);
    	};

    	return [width, url, methods];
    }

    class Image_container extends SvelteComponent {
    	constructor(options) {
    		super();
    		if (!document.getElementById("svelte-1k9t1tq-style")) add_css$1();
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { width: 0, url: 1, methods: 2 });
    	}
    }
